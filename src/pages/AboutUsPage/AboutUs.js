  ...
  return (
    <section className="p-5" id="AboutUs">
      <div className="d-grid text-center container m-0">
        <h1 className=" fw-bold  text-decoration-underline mb-4 link-offset-2 link-offset-1-hover">WELCOME TO VELAN FACILITY SERVICE </h1>
      ...
      <div>
        <div className='px-md-5' id="OurMission">
          <h2 className="text-center text-decoration-underline mb-4 link-offset-2 link-offset-1-hover">Our Mission</h2>
        ...
        <div className='px-md-5' id="OurPurpose">
          <h2 className="text-center text-decoration-underline mb-4 link-offset-2 link-offset-1-hover">Our Purpose</h2>
          <div className="row m-0">
        ...
        <div className='px-md-5' id="OurServices">
          <h2 className="text-center text-decoration-underline mb-4 link-offset-2 link-offset-1-hover">Our Services</h2>
          <div className="row m-0">
        ...
        <div className="row m-0 px-md-5 " id="WhyChoose">
          <h2 className="col-12 order-0 text-decoration-underline mb-4 link-offset-2 link-offset-1-hover">Why Choose VFS ?</h2>
        ...
        <div className="row m-0 px-md-5 " id="HowWeWork">
          <h2 className="col-12 text-decoration-underline mb-4 link-offset-2 link-offset-1-hover">How We Work ?</h2>
        ...
        <div className="row m-0 px-md-5" id='WhyUs'>
          <h2 className="col-12 order-0 text-decoration-underline mb-4 link-offset-2 link-offset-1-hover">Why Us ?</h2>
          <div className="col-10 col-md-4 order-1 order-md-2 text-center mx-auto ">
