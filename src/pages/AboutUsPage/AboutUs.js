    ...
    <section className="" id="AboutUs">
      ...
      <div className="px-md-5">
        <div className="px-5 pt-5 pb-3">
          <div className="d-grid text-center container px-md-5 m-0">
            <h1
          ...
          <div>
            ...
            <div className="row m-0 px-md-5 " id="HowWeWork">
              ...
              <div className="col-10 col-md-4 text-center mx-auto align-content-center">
                <img
                  src={HowWeWork}
                  alt=""
                  height="auto"
                  className="mx-auto h-auto w-75 mb-4 mb-md-0  "
                />
              </div>
