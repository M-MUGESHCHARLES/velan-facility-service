...
export const HomePageSection1 = () => {
  return (
    <section className="py-3 px-5 row m-0" id="HomePageSection1">
        <h2 className="my-3 fw-bold text-center"> WELCOME TO VELAN FACILITY SERVICE </h2>
      <div className="col-12 col-lg-5 d-flex align-items-center" id="left">
        <img src={Hero1} alt='' height='auto' width='90%' className='mx-auto px-2 py-3'/>
      </div>
      <div className="col-12 col-lg-7 fw-semibold" id="right">
          ...
          <p className='indent'>
            Our security infrastructure has been meticulously designed with
            utmost care and precision under the expert guidance of skilled
            retired police officers and ex-defense personnel, ensuring that your
            premises are well-protected and fortified. VFS is strengthened by a
            well-trained and disciplined guard force, supported by a 24-hour
            control office that responds promptly to any emergencies, ensuring
