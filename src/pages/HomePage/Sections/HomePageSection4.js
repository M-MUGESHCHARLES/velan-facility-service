        ...
        <section className="py-3 px-5 row m-0" id="HomePageSection2">
          <div className="row m-0">
            <div className="col-12 text-center">
              <h2 className="my-2 fw-bold text-decoration-underline mb-4 link-offset-2 link-offset-1-hover lh-base"> MANPOWER SERVICES</h2>
            </div>
            <div className="col-12 row m-0 p-0">
              <div className="col-12 col-lg-8 fw-semibold p-0 d-flex order-1 order-lg-0" id="left">
                <p className="text-center align-self-center indent">
                  We Velan Facility Services provide all type of Manpower
            ...
            <div className="col-12 py-4 p-0">
              <CardCarousel service={ManPowerServices} category='manpower-service' />
            </div>
          </div>
