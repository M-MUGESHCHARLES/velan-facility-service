        ...
        <Slider {...settings}>
          <div className="banner-container">
            <div className="card text-bg-dark">
              ...
              <div className="card-img-overlay d-flex align-items-center">
                <div className='p-5'>
                  <h3 className="card-title text-warning fw-bold pb-4">Security Service</h3>
                  <p className="card-text p-3">Security is our core business and we are very passionate about our work.</p>
          ...
          <div className="banner-container">
            <div className="card text-bg-dark">
              ...
              <div className="card-img-overlay d-flex align-items-center">
                <div className='p-5'>
                  <h3 className="card-title text-warning fw-bold pb-4">Dog SQUAD Service</h3>
                  <p className="card-text p-3">Our dog squad comprise of highly pedigreed and trained German Shepherds, Doberman and Labradors canine along with skilled and experienced handlers.</p>
                  <a href='#' target='parent' className=' d-inline fw-bold pe-5 ps-3 py-2 rounded-1 text-bg-warning text-secondary' id='ReadMore' > Read More  </a>
                </div>
              </div>
            </div>          
          ...
          <div className="banner-container">
            <div className="card text-bg-dark">
              ...
              <div className="card-img-overlay d-flex align-items-center">
                <div className='p-5'>
                  <h3 className="card-title text-warning fw-bold pb-4">House Keeping Service </h3>
                  <p className="card-text p-3">We follow best housekeeping practice to earn customer satisfaction and thereby customer retention.</p>
                  <a href='#' target='parent' className=' d-inline fw-bold pe-5 ps-3 py-2 rounded-1 text-bg-warning text-secondary' id='ReadMore' > Read More  </a>
                </div>
              </div>
            </div>        
