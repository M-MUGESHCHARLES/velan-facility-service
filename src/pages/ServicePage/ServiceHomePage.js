          ...
          <div class="card m-0 p-0">
            ...
            <div class="card-img-overlay text-center align-content-center text-white">
              <h3 className="position-relative fw-bold fs-1 mt-auto mb-auto">
                <span className="border-5 rounded-4 border-primary border py-3 px-1 border-bottom-0 border-end-0 ">
                  <span className="border-5 rounded-3 border-primary-subtle border py-2 px-4 border-bottom-0 border-end-0 ">
                    {s.title}
                  </span>
                </span>
              </h3>
