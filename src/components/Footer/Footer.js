  ...
  return (
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
      ...
      <ul class="list-unstyled d-flex">
        <li class="ms-3"><a class="link-body-emphasis" href="http://www.facebook.com/"> <Facebook className='social-icons rounded-2'/> </a> </li>
        <li class="ms-3"><a class="link-body-emphasis" href="https://www.instagram.com/velan_facility_service?igsh=MWV4MW5peDlvazZoZg%3D%3D&utm_source=qr"> <Instagram className='social-icons rounded-2'/> </a> </li>
        <li class="ms-3"><a class="link-body-emphasis" href="https://youtube.com/@velanfacilityservice?si=XuZrUCB_N4VnSMDv"> <Youtube className='social-icons rounded-2'/> </a> </li>
      </ul>
    </div>
  </footer>
  )
