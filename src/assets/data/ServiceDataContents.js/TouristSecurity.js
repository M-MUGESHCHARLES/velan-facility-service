...
export const TouristSecurity = () => {
  return (
    <div className="indent px-5">
      ...
      <p className='my-3'>
        However, growing security concerns may make visitors hesitant to travel.
        That's where we come in. Velan Facility Services provides Personal
        Protection Officers available 24/7 to ensure your safety throughout your
        journey in India. We also offer a real-time GPS tracking solution for
        added security.
      </p>
      <p className='my-3'>
        While our head office is in Mumbai, we can arrange Personal Protection
      ...
      <ul className='mb-3'>
        ...
        <li>Options for male or female security officers</li>
        <li>24/7 support, guidance, and tracking</li>
        <li>Local insights on safe places to visit</li>
        <li>Protection against scams and tricks</li>
        <li>
          Our Close Protection Officers serve as guides, translators,
