  ...
  return (
    ...
    <h4 className='my-4 fw-bold'>Manned Guarding Service &ndash; Armed and Unarmed</h4>
      <p className='mt-3'>
        ...
        Facility Services offers a range of security personnel to meet various
        needs:
      </p>
      <ul className='mb-3'> 
      ...
      <p className='my-3'>
        At Velan Facility Services, we provide trained, professional, and
        uniformed security personnel to protect your business efficiently and
        economically. For customized security solutions or to upgrade your
        existing setup, contact us for a consultation and quote.
      </p>
    </div>
  );
}
