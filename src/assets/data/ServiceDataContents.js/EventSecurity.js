  ...
  return (
    <div className="indent px-5">
      ...
      <ul className='mb-3'>
        ...
        <li>Escort Guards for female staff/guests</li>
        <li>Male and Female Bouncers</li>
        <li>Close Protection Officers</li>
        <li>Security Guards (with ceremonial uniforms)</li>
        <li>Dog Squad</li>
        <li>
          Security Gadgets (metal detectors, walkie-talkies, alcohol testers,
          etc.)
        </li>
      </ul>
      ...
      <p className='my-3'>
        Velan Facility Services &ndash; Your trusted partner for event security.
      </p>
    </div>
  );
}
